@echo off
chcp 65001 >nul
title Start Deployment - Special Ad Member Bot

echo.
echo ========================================
echo    Start Deployment - Special Ad Member Bot
echo ========================================
echo.

echo 🚀 شروع استقرار ربات ادممبر
echo.
...
echo 1️⃣ **تنظیم Git:**
echo.
echo تنظیم نام کاربری: mohib4626
echo تنظیم ایمیل: mohibaddinsaife@gmail.com
echo.
