@echo off
chcp 65001 >nul
title Clean and Deploy - Special Ad Member Bot

echo.
echo ========================================
echo    Clean and Deploy - Special Ad Member Bot
echo ========================================
echo.

echo 🧹 پاکسازی فایل‌های اضافی
echo.

echo 📋 **مشکل:**
echo - فایل‌های اضافی GitHub در پوشه وجود دارد
echo - Repository هنوز ایجاد نشده است
echo - نیاز به پاکسازی و استقرار مجدد است
echo.
...
echo 2️⃣ **پاکسازی فایل‌های اضافی:**
echo.
echo در حال حذف فایل‌های اضافی...
del "New repository.py" 2>nul
rmdir /s /q "New repository_files" 2>nul
echo ✅ فایل‌های اضافی حذف شدند
echo.
