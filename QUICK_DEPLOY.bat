@echo off
chcp 65001 >nul
title Quick Deploy - Special Ad Member Bot

echo.
echo ========================================
echo    Quick Deploy - Special Ad Member Bot
echo ========================================
echo.

echo 🚀 راهنمای استقرار سریع
echo.
...
if /i "%choice%"=="Y" (
    ...
    echo 2. Public را انتخاب کنید
    echo 3. "Create repository" کلیک کنید
    echo.
    ...
    if /i "%github_done%"=="Y" (
        ...
        start cmd /k "cd /d %cd% && echo در حال آماده‌سازی Git..."
        ...
        if /i "%git_done%"=="Y" (
            ...
            echo 4. Repository خود را انتخاب کنید
            echo 5. Branch: main
