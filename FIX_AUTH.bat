@echo off
chcp 65001 >nul
title Fix GitHub Auth - Special Ad Member Bot

echo.
echo ========================================
echo    Fix GitHub Auth - Special Ad Member Bot
echo ========================================
echo.
...
echo - نیاز به تنظیم مجدد remote
...
if /i "%token_created%"=="Y" (
    ...
    echo 4️⃣ **تنظیم remote با Token:**
    echo.
