@echo off
chcp 65001 >nul
title Deploy With Username - Special Ad Member Bot

echo.
echo ========================================
echo    Deploy With Username - Special Ad Member Bot
echo ========================================
echo.

echo 🚀 استقرار با نام کاربری mohib4626
echo.
