@echo off
chcp 65001 >nul
title Complete Setup - Special Ad Member Bot

echo.
echo ========================================
echo    Complete Setup - Special Ad Member Bot
echo ========================================
echo.

echo 🎯 راه‌اندازی کامل ربات ادممبر
echo.
...
if /i "%login_done%"=="Y" (
    ...
    echo Repository name: lordbot
    echo Description: LordBot - Advanced Telegram Member Adder Bot
    ...
    if /i "%repo_done%"=="Y" (
        ...
        if /i "%token_created%"=="Y" (
            ...
            echo ایمیل: mohibaddinsaife@gmail.com
            echo Repository: lordbot
            echo آدرس: https://github.com/mohib4626/lordbot
            echo.
            ...
            git add .
            git commit -m "Initial commit - LordBot"
