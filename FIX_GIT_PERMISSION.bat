@echo off
chcp 65001 >nul
title Fix Git Permission - Special Ad Member Bot

echo.
echo ========================================
echo    Fix Git Permission - Special Ad Member Bot
echo ========================================
echo.

echo 🔧 حل مشکل دسترسی Git
echo.

echo 📋 **مشکل:**
echo - دسترسی Git محدود است
echo - پوشه .git ایجاد نشده است
echo - دسترسی به System32 محدود است
echo.

echo 🎯 **راه حل:**
echo.

echo 1️⃣ **بررسی مسیر فعلی:**
echo.
echo مسیر فعلی:
cd
echo.

echo 2️⃣ **انتقال به پوشه پروژه:**
echo.
cd "ربات ادممبر جدید"
echo مسیر جدید:
cd
...
echo 3️⃣ **تنظیم Git:**
echo.
echo نام کاربری Git: mohib4626
echo ایمیل Git: mohibaddinsaife@gmail.com
echo.
