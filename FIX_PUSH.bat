@echo off
chcp 65001 >nul
title Fix Push Issue - Special Ad Member Bot

echo.
echo ========================================
echo    Fix Push Issue - Special Ad Member Bot
echo ========================================
echo.
...
echo 📋 **مشکل:**
echo - Repository قبلاً ایجاد شده است
echo - فایل‌های remote با local متفاوت است
echo - نیاز به pull قبل از push است
echo.
...
echo 3️⃣ **حذف remote موجود:**
echo.
git remote remove origin
echo ✅ remote حذف شد
echo.

echo 4️⃣ **تنظیم remote جدید:**
echo.
git remote add origin https://github.com/mohib4626/lordbot.git
echo ✅ remote تنظیم شد
echo.

echo 5️⃣ **Pull از remote:**
echo.
echo در حال دریافت تغییرات از remote...
git pull origin main --allow-unrelated-histories

if errorlevel 1 (
    echo ⚠️ خطا در pull، ادامه می‌دهیم...
)

echo ✅ pull انجام شد
echo.

echo 6️⃣ **آپلود فایل‌ها:**
echo.
echo در حال آماده‌سازی Git...
git add .
git commit -m "Update - LordBot with all files"
...
echo 4. Repository lordbot را انتخاب کنید
echo 5. Branch: main
...
if /i "%railway_done%"=="Y" (
    ...
    if /i "%vars_done%"=="Y" (
        ...
        echo 🎉 **تبریک! ربات LordBot شما آماده است!**
        echo.
