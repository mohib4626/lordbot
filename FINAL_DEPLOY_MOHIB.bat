@echo off
chcp 65001 >nul
title Final Deploy Mohib - Special Ad Member Bot

echo.
echo ========================================
echo    Final Deploy Mohib - Special Ad Member Bot
echo ========================================
echo.

echo 🚀 استقرار نهایی برای mohib4626
echo.
