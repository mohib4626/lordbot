@echo off
chcp 65001 >nul
title Auto Install All - Special Ad Member Bot

echo.
echo ========================================
echo    Auto Install All - Special Ad Member Bot
echo ========================================
echo.

echo 🚀 نصب خودکار تمام پیش‌نیازها و راه‌اندازی سیستم
echo.

echo 📋 **مرحله 1: بررسی نرم‌افزارهای موجود...**
echo.
...
echo 📦 **مرحله 2: نصب کتابخانه‌های Python...**
echo.
...
echo 🚀 **مرحله 4: شروع استقرار خودکار...**
echo.

echo 📝 **مرحله 4.1: ایجاد Repository در GitHub**
...
if /i "%github_done%"=="Y" (
    ...
    echo 📤 **مرحله 4.2: آپلود فایل‌ها به GitHub**
    echo.
    ...
    echo 🌐 **مرحله 4.3: استقرار روی Railway**
    ...
    if /i "%railway_done%"=="Y" (
        ...
        echo ⚙️ **مرحله 4.4: تنظیم متغیرهای محیطی**
        echo.
